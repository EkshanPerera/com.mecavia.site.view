    ...
    function setValues(code) {
        ...
        if (code) {
            ...
            if (purchaserequisitionobj != undefined) {
                ...
                $("#nettotal").text(commaSeparateNumber(String(purchaserequisitionobj.totalAmount)));
                $(".tax").text("0.0%")
                $("#grosstotal").text(commaSeparateNumber(String((purchaserequisitionobj.totalAmount) * (100 + 0.0) / 100)));
            } else {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
